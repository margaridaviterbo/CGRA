...
LightingScene.prototype.init = function(application) {
	...
	this.wallMaterial.setDiffuse(0,0.5,0.5,1);
	this.wallMaterial.setSpecular(0.5,0.5,1,1);
	...
	this.floorMaterial.setDiffuse(0.17,0.11,0.06,1);
	this.floorMaterial.setSpecular(0.17,0.11,0.06,1);
	this.floorMaterial.setShininess(120);

	//colum
	this.columMaterial = new CGFappearance(this);
	this.columMaterial.setAmbient(0.3,0.3,0.3,1);
	this.columMaterial.setDiffuse(0.4,0,0.4,1);
	this.columMaterial.setSpecular(1,1,1,1);
	this.columMaterial.setShininess(200);
